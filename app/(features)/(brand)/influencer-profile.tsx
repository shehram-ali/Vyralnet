...
import { GreenInstaSvg, WizardBadge1Svg, WizardBadge2Svg } from '../../../assets/images';
...
export default function InfluencerProfileScreen() {
  ...
  const progressPercentage = Math.min((influencer.stats.xpScore / 500) * 100, 100);
  ...
  return (
    <SafeAreaView className="flex-1 bg-[#F8F8F8]" edges={['top']}>
      ...
      >
        ...
        <View className="bg-white px-5 pt-6 pb-4">
              ...
              <View className="flex-row items-start justify-between mb-1">
                <View className="flex-1">
                  <View className="flex-row items-center mb-1">
                    <Text className="text-md font-bold text-black mr-2">
                      {influencer.name}
                    </Text>
            ...
            <View className="flex-row items-center justify-between mb-2">
              <View>
                <Text className="text-lg font-bold text-black">
                  {influencer.stats.xpScore}/500
                </Text>
                <Text className="text-xs text-gray-500">XP ON ACCOUNT</Text>
              </View>
              <View className="items-center">
                <Text className="text-xs font-semibold text-black mb-1">
          ...
          <View className="flex-row gap-3 mb-4">
            <TouchableOpacity
              ...
              activeOpacity={0.7}
              className="flex-1 border-2 border-[#5EBD3E] rounded-xl py-3 items-center"
            >
        ...
        {/* Tabs */}
        <View className="flex-row bg-white mt-2 px-5 pt-2">
          <TouchableOpacity
